...
// QuizItem maps to Backend response: quizId, not id
...
export function StudentDashboard() {
  ...
  // Backend returns raw array, not { items: [...] }
  const { data, isLoading, error } = useQuery({ queryKey: ['studentQuizzes'], queryFn: async () => (await apiClient.get('/quizzes')).data as QuizItem[] });
